...
[McpServerToolType]
public sealed class FormatDocumentTool(IRefactoringService refactoringService)
{
    ...
    [Description(
        """
        Use this tool when you need to format exactly one C# source document in the loaded solution using 
        the solution's current formatting and style settings. Returns whether formatting changes were 
